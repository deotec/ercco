...
GlobalConfig::$CONNECTION_SETTING->DBName = "ercco";
...
/** the root url of the application with trailing slash, for example http://localhost/ercco/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'ercco/';
