...
require_once("DAO/PlataformaCriteriaDAO.php");

/**
 * The PlataformaCriteria class extends PlataformaDAOCriteria and is used
 ...
 * @version 1.0
 */
class PlataformaCriteria extends PlataformaCriteriaDAO
{
