...
require_once("DAO/PermissaoCriteriaDAO.php");

/**
 * The PermissaoCriteria class extends PermissaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class PermissaoCriteria extends PermissaoCriteriaDAO
{
