...
require_once("DAO/RelUsuarioGrupoCriteriaDAO.php");

/**
 * The RelUsuarioGrupoCriteria class extends RelUsuarioGrupoDAOCriteria and is used
 ...
 * @version 1.0
 */
class RelUsuarioGrupoCriteria extends RelUsuarioGrupoCriteriaDAO
{
