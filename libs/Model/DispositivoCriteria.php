...
require_once("DAO/DispositivoCriteriaDAO.php");

/**
 * The DispositivoCriteria class extends DispositivoDAOCriteria and is used
 ...
 * @version 1.0
 */
class DispositivoCriteria extends DispositivoCriteriaDAO
{
